...
public class SevereInjuryFistEnchantment extends Enchantment {
    
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("severe_injury_fist");
    }

    public SevereInjuryFistEnchantment() {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity && event.getSource().getEntity() instanceof Player player) {
            ...
            int enchantmentLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.SEVERE_INJURY_FIST.get(), chestplate);
