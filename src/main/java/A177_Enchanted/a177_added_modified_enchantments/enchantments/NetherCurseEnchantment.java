...
public class NetherCurseEnchantment extends Enchantment {
    // 获取配置
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("nether_curse");
    }

    public NetherCurseEnchantment() {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity && event.getSource().getEntity() instanceof Player player) {
            ...
            int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.NETHER_CURSE.get(), mainHandItem);
