...
public class FocusedCriticalEnchantment extends Enchantment {
    // 获取配置
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("focused_critical");
    }

    public FocusedCriticalEnchantment() {
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (source.getEntity() instanceof Player player) {
            ...
            if (player.isCrouching()) {
                ...
                int level = weapon.getEnchantmentLevel(ModEnchantments.FOCUSED_CRITICAL.get());
