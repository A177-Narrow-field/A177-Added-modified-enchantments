...
public class OverworldCorrosionEnchantment extends Enchantment {
    // 获取配置
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("overworld_corrosion");
    }

    public OverworldCorrosionEnchantment() {
    ...
    private static void checkAndDamageItem(ItemStack stack, Player player) {
        ...
        // 检查物品是否有主界腐蚀附魔
        if (stack.getEnchantmentLevel(ModEnchantments.OVERWORLD_CORROSION.get()) <= 0) {
            return;
        }
