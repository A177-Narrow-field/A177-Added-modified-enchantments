...
public class NetherCorrosionEnchantment extends Enchantment {
    // 获取配置
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("nether_corrosion");
    }

    public NetherCorrosionEnchantment() {
    ...
    private static void checkAndDamageItem(ItemStack stack, Player player) {
        ...
        // 检查物品是否有下届腐蚀附魔
        if (stack.getEnchantmentLevel(ModEnchantments.NETHER_CORROSION.get()) <= 0) {
            return;
        }
