...
public class EmptyMindFistEnchantment extends Enchantment {
    
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("empty_mind_fist");
    }

    public EmptyMindFistEnchantment() {
    ...
    protected boolean checkCompatibility(Enchantment other) {
        return super.checkCompatibility(other) && other != ModEnchantments.RED_RUSH_FIST.get();
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity && event.getSource().getEntity() instanceof Player player) {
            ...
            int enchantmentLevel = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.EMPTY_MIND_FIST.get(), chestplate);
