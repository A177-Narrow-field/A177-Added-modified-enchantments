...
public class BloodthirstyEnchantment extends Enchantment {
    ...
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("bloodthirsty");
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (event.getEntity() instanceof LivingEntity && event.getSource().getEntity() instanceof Player player) {
            ...
            int level = EnchantmentHelper.getItemEnchantmentLevel(ModEnchantments.BLOODTHIRSTY.get(), mainHandItem);
