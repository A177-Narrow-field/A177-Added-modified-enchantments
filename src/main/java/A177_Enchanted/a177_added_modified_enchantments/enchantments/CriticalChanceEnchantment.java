...
public class CriticalChanceEnchantment extends Enchantment {
    private static final Random RANDOM = new Random();
    
    // 获取配置
    private static AllEnchantmentsConfig.EnchantConfig getConfig() {
        return AllEnchantmentsConfig.ENCHANTMENTS.get("critical_chance");
    }
    ...
    protected boolean checkCompatibility(Enchantment other) {
        // 与专心暴击附魔冲突
        return super.checkCompatibility(other) && other != ModEnchantments.FOCUSED_CRITICAL.get();
    }
    ...
    public static void onLivingHurt(LivingHurtEvent event) {
        ...
        if (source.getEntity() instanceof Player player) {
            ...
            int level = weapon.getEnchantmentLevel(ModEnchantments.CRITICAL_CHANCE.get());
